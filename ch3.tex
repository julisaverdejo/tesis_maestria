  ...
  \section{Convertidores Analógico-Digitales}
    ...
    \begin{table}[h!]
      ...
      \resizebox{\textwidth}{!}{
        \begin{NiceTabular}{|c|c|c|c|c|}
          \hline
          \textbf{Characteristic} & \textbf{Flash} & \textbf{Pipelined} & \textbf{SAR} & \textbf{Sigma-Delta}\\ 
          \hline
          Throughput & 1 & 2 & 3 & 4 \\ 
          ...
          Simplified anti-aliasing &  &  &  & $\star$ \\ 
          Can undersample & $\star$ & $\star$ & $\star$ &  \\ 
          Can increase resolution through averaging (with dither noise) & $\star$ & $\star$ & $\star$ &  \\ 
          \hline
        \end{NiceTabular}
      }
